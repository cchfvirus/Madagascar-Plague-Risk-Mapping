...
- **Risk Zones** - Integrated transmission risk assessment (Maxent + LandScan Mosaic)
- **Hot Spot Analysis** - Spatial clustering of plague activity (Getis-Ord Gi*)

**Overlay Layer**:
- **Plague Cases** - Historical case locations (click markers for details)

## 🎯 Features

- Toggle between different risk assessment layers
- View detailed plague case information
- Right-click map to copy coordinates (useful for field work)
- Interactive zoom and pan with OpenStreetMap basemap
...
*Detailed methods, data sources, and validation are provided in the publication.*
